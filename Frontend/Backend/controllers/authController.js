    ...
    try {
      if (name && email && password) {
        ...
        if (isUser) {
          ...
          const link = `http://13.201.81.133:3000/api/auth/verify/${token}`;
    ...
    try {
      if (email) {
        ...
        if (isUser) {
          ...
          const link = `http://13.201.81.133:3001/user/reset/${isUser._id}/${token}`;
    ...
    try {
      if (email) {
        ...
        if (isUser) {
          ...
          const link = `http://13.201.81.133:3001/user/sendEmail/${isUser._id}/${token}`;
