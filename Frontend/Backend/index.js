...
const allowedOrigins = ['http://localhost:3001', 'http://43.204.107.127:3000','http://43.204.107.127 ','http://43.204.107.127:3001'];
...
app.listen(PORT, () => {
  console.log(`API is running on http://43.204.107.127:${PORT}`);
});
