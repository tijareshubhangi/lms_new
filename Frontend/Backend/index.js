...
const allowedOrigins = ['http://localhost:3001', 'http://65.0.127.154:3000','http://65.0.127.154 ','http://65.0.127.154:3001'];
...
app.listen(PORT, () => {
  console.log(`API is running on http://65.0.127.154:${PORT}`);
});
