...
const allowedOrigins = ['http://localhost:3001', 'http://13.232.88.198:3000','http://13.232.88.198 ','http://13.232.88.198:3001'];
...
app.listen(PORT, () => {
  console.log(`API is running on http://13.232.88.198:${PORT}`);
});
