...
const allowedOrigins = ['http://localhost:3001', 'http://3.110.27.127:3000','http://3.110.27.127 ','http://3.110.27.127:3001'];
...
app.listen(PORT, () => {
  console.log(`API is running on http://3.110.27.127:${PORT}`);
});
